...
#### 3.8.12 const 和数组 <a id="const 和数组"></a>
...
### 5.4 字符串库 cctype <a id="字符串库 cctype"> </a>
...
#### 5.6.1 使用枚举量作为标签 <a id="使用枚举量作为标签"></a>
...
### 5.7 break 和 continue 语句 <a id="break 和 continue 语句"></a>
...
### 6.1 函数定义 <a id="函数定义"></a>
按照函数是否有返回值可以将函数分为两类：有返回值的、无返回值的。
#### 6.1.1 void 函数 <a id="void 函数"></a>
...
### 6.3 函数参数和按值传递 <a id="函数参数和按值传递"></a>
...
### 6.4 函数和数组 <a id="函数和数组"></a>
参数和返回值类型可以是基本类型，也可以是像数组或结构这样复杂的类型。
#### 6.4.1 传递数组 <a id="传递数组"></a>
...
#### 6.4.3 使用数组区间的函数 <a id="使用数组区间的函数"></a>
一般的处理数组的函数需要两个参数：
1. 数组名
2. 数组长度
...
### 6.5 函数和C-风格字符串 <a id="函数和C-风格字符串"></a>
由于 C-风格字符串本身就是一种数组，所以我们使用的方法和使用数组的方法一样。
#### 6.5.1 传递 C-风格字符串 <a id="传递C-风格的字符串"></a>
...
## 八、内存模型和名称空间 <a id="名称空间"></a>
### 8.1 单独编译 <a id="单独编译"></a>
...
### 8.3 存储持续性、作用域和链接性 <a id="存储持续性、作用域和链接性"></a>
C++ 使用三种方案来存储数据：
...
#### 8.3.4 静态持续性、外部链接性 <a id="静态持续性、外部链接性"></a>
...
#### 8.3.5 静态持续性、内部链接性 <a id="静态持续性、内部链接性"></a>
...
#### 8.3.6 静态持续性、无链接性 <a id="静态持续性、无链接性"></a>
...
### 8.8 名称空间 <a id="名称空间"></a>
当变量增加时，名称可能冲突。C++标注提供了名称空间工具。
#### 8.8.1 传统的 C++ 名称空间 <a id="传统的名称空间"></a>
1. **声明区域**：
...
##### 8.8.2.2 using 问题 <a id="using问题"></a>
